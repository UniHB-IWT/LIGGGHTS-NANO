...
#ifdef NORMAL_MODEL
NORMAL_MODEL(HERTZ_STIFFNESS_NANO,hertz/stiffness/nano,5)
#else
#ifndef NORMAL_MODEL_HERTZ_STIFFNESS_NANO_H_
#define NORMAL_MODEL_HERTZ_STIFFNESS_NANO_H_
...
{
  template<>
  class NormalModel<HERTZ_STIFFNESS_NANO> : public NormalModelBase
  {
  public:
    ...
    void connectToProperties(PropertyRegistry & registry)
    {
      ...
      registry.connect("k_n", k_n,"model hertz/stiffness/nano");
      registry.connect("k_t", k_t,"model hertz/stiffness/nano");
      registry.connect("gamma_n", gamma_n,"model hertz/stiffness/nano");
      registry.connect("gamma_t", gamma_t,"model hertz/stiffness/nano");

      // error checks on coarsegraining
      if(force->cg_active())
        error->cg(FLERR,"model hertz/stiffness/nano");
    }
    ...
    inline void surfacesIntersect(SurfacesIntersectData & sidata, ForceData & i_forces, ForceData & j_forces)
    {
      ...
      // LIGGGHTS-NANO
      // account for area-scaling of the damping coefficients.
      ...
      if(!displayedSettings)
      {
        ...
        /*
        if(limitForce)
            if(0 == comm->me) fprintf(screen," NormalModel<HERTZ_STIFFNESS_NANO>: will limit normal force.\n");
        */
      }
...
#endif // NORMAL_MODEL_HERTZ_NANO_H_
#endif
